...
= 1.2.5 =
* FIXED: Responsive settings now correctly applied on frontend (animation and effect settings)
* FIXED: Viewport-specific settings passed to JavaScript for all effects
